...
public class HttpUtils {
    ...
    public static void main(String[] args) {
		HttpUtils http = HttpUtils.post("http://testtimerbackend.geexek.cn/mergeCmpt.do");
//		List<NameValuePair> pairs = null;
//		http.addHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8");
//		http.setContentEncoding("UTF-8");
		http.addParameters(new BasicNameValuePair("cmpt", "{\"cmptId\":200,\"cmptName\":\"testcmpt中文\"}"));
		http.setContentType("application/x-www-form-urlencoded", Charset.forName("UTF-8"));
